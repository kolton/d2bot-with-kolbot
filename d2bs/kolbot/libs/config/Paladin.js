...
function LoadConfig() {
	...
	*/
	...
	Config.QuitListDelay = []; // Delay of quiting the game after QuitList character left. Randomized time will determined used by the given range. Example for 1 to 10 seconds delay use: Config.QuitListDelay = [1, 10];
