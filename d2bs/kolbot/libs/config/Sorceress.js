...
function LoadConfig() {
	...
	Scripts.Diablo = false;
		...
		Config.Diablo.ClearPath = false; //Clear path if walking to Diablo, regardless of if the character is teleporting or not.
	...
	Scripts.Baal = false;
		...
		Config.Baal.ClearPath = false; // Clear the path to Baal, regardless of if the character is teleporting or not.
