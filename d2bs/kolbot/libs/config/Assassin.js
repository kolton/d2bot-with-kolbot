...
function LoadConfig() {
	...
	*/
	...
	Config.DroppedItemsAnnounce = false;	// Announce Dropped Items to in-game newbs
	Config.DroppedAnnounceQuality = []; // Quality of item to announce
	Config.DroppedItemsLogOOG = false; // Show Field Dropped items in OOG Item Viewer Log
	Config.DroppedItemsLogOOGQuality = []; // Quality of item to show in OOG Item Viewer Log
